...
def main_menu():
    ...
    while True:
        ...
        print("1. Ejecutar cadena de prueba 'accept_input'")
        print("2. Ejecutar cadena de prueba 'reject_input'")
        print("3. Ejecutar cadena de prueba 'infinite_input'")
        print("4. Ingresar una cadena manualmente")
        print("5. Salir")
